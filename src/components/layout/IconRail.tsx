...
export function IconRail() {
  ...
  return (
    <aside
      className="hidden lg:flex flex-col items-center fixed left-0 top-0 w-16 h-screen z-40"
      style={{
    ...
    >
      {/* Logo */}
      <div
        className="mt-5 mb-8 w-10 h-10 rounded-xl flex items-center justify-center animate-warm-pulse cursor-pointer"
        style={{
